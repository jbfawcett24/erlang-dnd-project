...
get_race(human) ->
    #race{
        ...
        ability_score_improvements = [{"Any", 1}, {"Any", 1}, {"Any", 1}, {"Any", 1}, {"Any", 1}, {"Any", 1}]
    };
get_race(high_elf) ->
    #race{
        name = "High Elf",
        speed = 30,
        abilities = [{"Darkvision", 1}, {"Keen Senses", 1}, {"Fey Ancestry", 1}, {"Trance", 1}, {"Elf Weapon Training", 1}, {"Cantrip", 1}],
        ability_score_improvements = [{"Intelligence", 1}, {"Dexterity", 2}]
    };
get_race(wood_elf) ->
    #race{
        name = "Wood Elf",
        ...
        ability_score_improvements = [{"Wisdom", 1}, {"Dexterity", 2}]
    };
get_race(dark_elf) ->
    #race{
        name = "Dark Elf",
        speed = 30,
        abilities = [{"Superior Darkvision", 1}, {"Keen Senses", 1}, {"Fey Ancestry", 1}, {"Trance", 1}, {"Drow Magic", 1}],
        ability_score_improvements = [{"Charisma", 1}, {"Dexterity", 2}]
    };
get_race(hill_dwarf) ->
    #race{
        name = "Hill Dwarf",
        speed = 25,
        abilities = [{"Darkvision", 1}, {"Dwarven Resilience", 1}, {"Dwarven Combat Training", 1}, {"Tool Proficiency", 1}, {"Stonecunning", 1}, {"Dwarven Toughness", 1}],
        ability_score_improvements = [{"Wisdom", 1}, {"Constitution", 2}]
    };
% ...existing code...
get_race(mountain_dwarf) ->
    #race{
        name = "Mountain Dwarf",
        speed = 25,
        abilities = [{"Darkvision", 1}, {"Dwarven Resilience", 1}, {"Dwarven Combat Training", 1}, {"Tool Proficiency", 1}, {"Stonecunning", 1}, {"Dwarven Armor Training", 1}],
        ability_score_improvements = [{"Strength", 2}, {"Constitution", 2}]
    };
...
get_race(stout_halfling) ->
    #race{
        ...
        ability_score_improvements = [{"Constitution", 1}, {"Dexterity", 2}]
    };
get_race(dragonborn) ->
    #race{
        name = "Dragonborn",
